...
Проект работает на [Django 1.11.1](https://docs.djangoproject.com/en/5.1/releases/1.11.1/). 
Сейчас очень нужна помощь с моделированием системы, почитать о котором можно [здесь](https://docs.djangoproject.com/en/5.1/topics/db/models/).
